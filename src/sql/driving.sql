...
CREATE TABLE `order` (
  ...
  `class_def_id` varchar(16) DEFAULT NULL,
  `ground_id` varchar(16) DEFAULT NULL,
...
(
	id varchar(16) not null comment '班型总表id'
		primary key,
	name_id varchar(16) null comment '班型名称id',
	type_id varchar(16) null comment '班型类别id',
...
(
  id varchar(16) not null comment '班型名称id'
    primary key,
